  ...
  const loadRom = function($router, rom, soundOn = true) {
    ...
    function saveToSlot(slotNum) {
      if(GameBoyEmulatorInitialized()) {
        pause();
        var gameName = "Escape_Obliterizer_Deluxe";
    ...
    function runGB(romBuffer) {
      ...
      function inGameMode() {
        ...
        KaiBoyMachinePaused = false
        console.log('ROM loaded:', "Escape_Obliterizer_Deluxe")
        $router.setHeaderTitle("Escape_Obliterizer_Deluxe");
      }
    ...
    $router.push(
      new Kai({
        ...
        softKeyText: { left: '', center: 'PAUSE', right: '' },
        softKeyListener: {
          left: function() {
          },
          center: function() {
